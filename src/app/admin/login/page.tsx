...
export default function AdminLoginPage() {
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      // Only allow admin roles on this login page
      if (!ADMIN_ROLES.includes(result.role)) {
        toast.error('Access denied. Use the player login page.')
  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#111518' }}>
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-tx-primary">Admin Portal</h1>
          <p className="text-xs text-tx-muted mt-1">Sign in to your admin account</p>
        </div>
